...
function Header() {
    ...
    function sideNavWidth() {
        if (window.innerWidth > 500) {
            setNavStyle({ width: "50%", paddingLeft: "5rem" })
        } else {
            setNavStyle({ width: "70%", paddingLeft: "5rem" })
        }
    }

    function sideNavNoWidth() {
        setNavStyle({})
    }
        ...
        <>
            ...
            <nav className='flex justify-between items-center pl-24 pr-20 py-7 bg-[#E3E6F3] shadow-[0_5px_15px_rgba(0,0,0,0.06)] sticky top-0 z-10'>
                ...
                <ul className='hidden tablet:flex items-center text-2xl text-[#1a1a1a]'>
                    ...
                    <li><button onClick={sideNavWidth}><MenuIcon className='cursor-pointer hover:text-[#088178] tablet:!text-[22px]' fontSize='large'></MenuIcon></button></li>
                </ul>
            </nav>

            <ul style={navStyle} id='mobileSideNav' className='!font-sans bg-[#E3E6F3] text-[1.7rem] text-[#1a1a1a] fixed top-0 right-0 w-0 h-screen font-semibold flex flex-col items-start shadow-[0_40px_60px_rgba(0,0,0,0.1)] z-20 duration-300'>
                <li className='mt-20 mb-7'><button onClick={sideNavNoWidth}><CloseIcon className='hover:text-[#088178] cursor-pointer' fontSize='large'></CloseIcon></button></li>
                ...
                <li className='my-7 relative'><NavLink className='hover:text-[#088178] after:absolute after:w-[70%] after:h-[1.5px] after:bottom-[-3px] after:left-0 hover:after:bg-[#088178] duration-300 after:duration-300' to='/shop'>Shop</NavLink></li>
                <li className='my-7 relative'><NavLink className='hover:text-[#088178] after:absolute after:w-[70%] after:h-[2px] after:bottom-[-3px] after:left-0 hover:after:bg-[#088178] duration-300 after:duration-300' to='/blog'>Blog</NavLink></li>
                <li className='my-7 relative'><NavLink className='hover:text-[#088178] after:absolute after:w-[70%] after:h-[1.5px] after:bottom-[-3px] after:left-0 hover:after:bg-[#088178] duration-300 after:duration-300' to='/about'>About</NavLink></li>
                <li className='my-7 relative'><NavLink className='hover:text-[#088178] after:absolute after:w-[70%] after:h-[1.5px] after:bottom-[-3px] after:left-0 hover:after:bg-[#088178] duration-300 after:duration-300' to='/contact'>Contact</NavLink></li>
            </ul>
        </>
    )
}
