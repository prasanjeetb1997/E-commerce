...
function Newsletter() {
    return (
        <div id='newsletter-section' className='bg-newsletter-img bg-no-repeat bg-[20%_30%] bg-[#041e42] flex justify-between flex-wrap items-center py-20 px-32 mobile:py-10 mobile:px-5'>
